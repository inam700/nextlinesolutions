      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
        ...
        <div className="order-1 md:order-2">
          ...
          {coreValues.map((item, index) => (
            <p key={index} className="text-gray-700 text-sm md:text-base mb-5">
          ...
          <div className="mt-10">
            <Link
              href={"/about"}
              type="button"
              className="rounded-full text-sm font-bold px-10 py-3 bg-logoColorPrimary text-white hover:shadow-slate-800 transition-shadow duration-300 ease-in-out"
            >
              Learn More
            </Link>
          </div>
