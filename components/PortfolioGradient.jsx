    ...
    <div className="h-full">
      ...
      >
        <div className="">
          ...
          <div className="flex gap-3 flex-wrap mt-10">
            {item.tags.map((tag) => (
              <div className="flex items-center gap-2 group rounded-md border shadow-md hover:shadow-xl hover:bg-white hover:text-black px-4 py-2">
                <Image
                  src={tag.image}
                  className="w-8 invert group-hover:invert-0"
                  alt="tag"
